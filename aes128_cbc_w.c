...
int main(){
    ...
    */
    ...
    const char *filename_1 = "tables/td_rsakey_enc_aes_128cbc_writer.csv";
    const char *filename_2 = "tables/td_enc_aes_128cbc_writer.csv";
    const char *filename_3 = "tables/td_aes_128cbc_writer.csv";
    ...
    */
    ...
    if (1 != EVP_EncryptInit_ex(ctx_aes, EVP_aes_128_cbc(), NULL, key, iv)) {
        ERR_print_errors_fp(stderr);
        EVP_CIPHER_CTX_free(ctx_aes);
        close(fd);
        return EXIT_FAILURE;
