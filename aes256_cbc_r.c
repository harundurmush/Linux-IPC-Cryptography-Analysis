...
int main(){
    ...
    const char *filename_1 = "tables/td_rsakey_dec_aes_256cbc_reader.csv";
    const char *filename_2 = "tables/td_dec_aes_256cbc_reader.csv";
    const char *filename_3 = "tables/td_aes_256cbc_reader.csv";
